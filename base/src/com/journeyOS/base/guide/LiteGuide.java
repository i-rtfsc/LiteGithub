...
public class LiteGuide {
    public static final String TAG = LiteGuide.class.getSimpleName();
     ...
     */
    public LiteGuide(Activity activity, @IdRes int contentId) {
        mActivity = activity;
     ...
     */
    public void setOnGuiderListener(OnGuideClickListener guiderClickListener) {
