...
import com.journeyOS.base.utils.GitHubName;
...
class HtmlHelper {
    ...
    static String generateMdHtml(@NonNull String mdSource, @Nullable String baseUrl,
        ...
        mdSource = BaseUtils.isBlank(baseUrl) ? mdSource : fixLinks(mdSource, baseUrl);
    ...
    private static String formatCode(@NonNull String codeSource) {
        if (BaseUtils.isBlank(codeSource)) return codeSource;
