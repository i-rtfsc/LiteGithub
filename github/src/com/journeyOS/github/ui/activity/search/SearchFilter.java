...
public class SearchFilter implements Parcelable {
    ...
    public SearchFilter(SearchType type) {
        this.type = type;
    }

    public SearchFilter(SearchType type, String query) {
        this.type = type;
        this.query = query;
    }
    ...
    public SearchFilter setSort(String sort) {
        this.sort = sort;
        return this;
    }

    public SearchFilter setSortId(int sortId) {
    ...
    public SearchFilter setDesc(boolean desc) {
        this.desc = desc;
        return this;
    }
